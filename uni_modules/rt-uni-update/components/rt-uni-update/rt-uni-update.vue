<template>
	<view class="update-mask flex-center">
		<view class="update-content botton-radius">
			<view class="content-top">
				<view class="content-top-text">
					<text class="">发现新版本 {{data.edition_name}}</text>
					<text class="update-version">当前版本：{{version}}</text>
				</view>
