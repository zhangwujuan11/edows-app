<template>
	<view class="uni-date">
        ...
        >
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						...
						<view class="uni-date__x-input" :class="displayValue ?'use':'no'">{{ displayValue || singlePlaceholderText }}<slot name="icon"></slot></view>
					</view>

          <view v-else class="uni-date-x uni-date-range">
            <uni-icons class="icon-calendar" type="calendar" color="#c0c4cc" size="22"></uni-icons>
            <view class="uni-date__x-input text-center" :class="displayRangeValue.startDate ?'use':'no'">
            ...
            <view class="uni-date__x-input text-center" :class="displayRangeValue.endDate ?'use':'no'">
    ...
    <Calendar v-if="isPhone" ref="mobile" :clearDate="false" :date="calendarDate" :defTime="mobileCalendarTime"
      ...
      :hideSecond="hideSecond" :dateType="dateType" @confirm="mobileChange" @maskClose="close" />
  </view>
</template>
<script>
  /**
