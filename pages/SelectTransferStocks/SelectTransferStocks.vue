    ...
    <view class="topserchbox">
      <view class="topserchboxcon">
        <view class="uni-input-wrapper" style="position: relative; width: 686upx; height: 72upx; padding-left: 40upx;">
          <input class="uni-input" placeholder="请输入产品名称" style="height: 100%;width: 606upx;text-align: center;"
          ...
          <view class="dowcontitle">
            <view class="state" style="position: relative;">
              <uni-icons type="checkmarkempty" size="26" v-show="item.inventoryId==id"
                style="color: #0067ff; position: absolute; top: 8upx;left: 6upx; background-color: #f3f7ff;"></uni-icons>
            </view>
  ...
  export default {
    ...
    methods: {
      ...
      doList(e) {
        ...
        uni.navigateTo({
          url: '/pages/addTransferStocks/addTransferStocks?obj=' + this.obj + '&obj1=' + this.obj1 + `&index=` +
            this.index
        })
      }
    }
